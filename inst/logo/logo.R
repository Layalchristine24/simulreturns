...
royalty_free_image <- image_read(system.file("logo", "graph-g27c31b3b7_1280.png",
                                             package = "simulreturns"
))

# set the package name
package_name <- "simulreturns"

# set the package url
url_package <- "https://github.com/Layalchristine24/simulreturns"
